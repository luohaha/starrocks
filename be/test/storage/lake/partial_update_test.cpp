...
TEST_P(LakePartialUpdateTest, test_parallel_row_mode_partial_update_multi_segments) {
    ...
    const int64_t old_write_buffer_size = config::write_buffer_size;
    const bool old_parallel_flag = config::lake_enable_parallel_row_mode_partial_update;
    config::write_buffer_size = 1;
    config::lake_enable_parallel_row_mode_partial_update = true;
    ...
    config::write_buffer_size = old_write_buffer_size;
    config::lake_enable_parallel_row_mode_partial_update = old_parallel_flag;
