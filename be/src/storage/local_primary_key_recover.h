...
public:
    LocalPrimaryKeyRecover(Tablet* tablet, UpdateManager* update_mgr, const EditVersion& version)
            : _tablet(tablet), _update_mgr(update_mgr), _version(version) {}
